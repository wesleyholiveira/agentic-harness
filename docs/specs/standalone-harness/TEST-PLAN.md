...
6. Compose gate — `docker compose --profile runtime config` and service startup on a Docker-enabled host;
7. integration gate — `harness:doctor`, migrations, Context Engine health, Rust worker heartbeat and an OpenCode-connected runtime smoke.
